  ...
  return (
    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2 p-3 bg-bg-panel/50 rounded-lg border border-border/50">
      <div class="flex flex-col gap-0.5">
        <span class={`text-2xs leading-tight text-txt-muted uppercase tracking-wider`}>Size</span>
      ...
      <Show when={props.file.segment_count}>
        <div class="flex flex-col gap-0.5">
          <span class={`text-2xs leading-tight text-txt-muted uppercase tracking-wider`}>Segments</span>
      ...
      <Show when={props.e01Info()?.acquiry_date}>
        <div class="flex flex-col gap-0.5">
          <span class={`text-2xs leading-tight text-txt-muted uppercase tracking-wider`}>Acquired</span>
      ...
      <Show when={props.ufedInfo()?.extraction_info?.start_time}>
        <div class="flex flex-col gap-0.5">
          <span class={`text-2xs leading-tight text-txt-muted uppercase tracking-wider`}>Extracted</span>
      ...
      <Show when={!props.hasAcquiryDate()}>
        <Show when={props.file.created}>
          <div class="flex flex-col gap-0.5">
            <span class={`text-2xs leading-tight text-txt-muted uppercase tracking-wider`}>File Created</span>
        ...
        <Show when={props.file.modified}>
          <div class="flex flex-col gap-0.5">
            <span class={`text-2xs leading-tight text-txt-muted uppercase tracking-wider`}>File Modified</span>
      ...
      <Show when={props.ad1Info()}>
        <div class="flex flex-col gap-0.5">
          <span class={`text-2xs leading-tight text-txt-muted uppercase tracking-wider`}>Items</span>
      ...
      <Show when={props.e01Info()}>
        <div class="flex flex-col gap-0.5">
          <span class={`text-2xs leading-tight text-txt-muted uppercase tracking-wider`}>Chunks</span>
        ...
        <div class="flex flex-col gap-0.5">
          <span class={`text-2xs leading-tight text-txt-muted uppercase tracking-wider`}>Sectors</span>
