...
/**
 * Viewer-specific metadata section renderers.
 *
 * Each section component renders metadata from a specific viewer type
 * (EXIF, Registry, Database, Binary, Email, Plist, Document, Spreadsheet,
 * Archive, Office).
 */
...
function SpreadsheetSection(props: {
