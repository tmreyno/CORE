...
/**
 * EvidenceCollectionListModal — Browse, review, and manage past evidence collections.
 *
 * Shows a list of all evidence collections for the current case/project.
 * Each collection is rendered as a card with summary info and action buttons:
 *  - Open (edit) / Review (read-only)
 *  - Export PDF
 *  - Delete (draft only)
...
const log = logger.scope("EvidenceCollectionListModal");

export interface EvidenceCollectionListModalProps {
  /** Case number for filtering */
  caseNumber?: string;
  /** Project name (shown in header) */
  projectName?: string;
  /** Called when user wants to open a collection for editing */
...
export function EvidenceCollectionListModal(
  props: EvidenceCollectionListModalProps
) {
  ...
  return (
    ...
    >
      <div class="modal-content w-[700px] max-h-[85vh] flex flex-col">
        {/* Header */}
        <div class="modal-header">
          <div class="flex items-center gap-3">
            ...
            <div>
              <h2 class="text-lg font-semibold">Evidence Collections</h2>
              <p class="text-xs text-txt-muted">
                Browse and manage past collection records
                      ...
                      <div class="flex items-start justify-between gap-4">
                        ...
                        <div class="flex items-center gap-1.5 flex-shrink-0">
                          ...
                          <button
                            ...
                            title="Review"
                            onClick={() =>
                              props.onOpenCollection(col.id, true)
                            }
                          >
                          ...
                          <Show when={(col.status || "draft") !== "locked"}>
                            <button
                              ...
                              title="Edit"
                              onClick={() =>
                                props.onOpenCollection(col.id, false)
                              }
                            >
                          ...
                          <Show when={props.onExport}>
                            <div class="relative">
                              ...
                              <Show when={exportMenuId() === col.id}>
                                <div
                                  class="absolute right-0 top-full mt-1 bg-bg-panel border border-border rounded-lg shadow-lg py-1 z-dropdown min-w-[160px]"
                                >
