      ...
      <Show when={mod("forensicExplorer")}>
        ...
        >
          ...
          <Show when={hasSelection()}>
            <span class="absolute -top-1.5 -right-1.5 flex items-center justify-center min-w-[22px] h-[22px] px-1.5 text-xs leading-none font-bold bg-accent text-white rounded-full shadow-sm">
              {props.selectedCount}
            </span>
          </Show>
        </button>
        ...
        >
          ...
          <Show when={hasEvidence()}>
            <span class="absolute -top-1 -right-1 flex items-center justify-center min-w-[20px] h-[20px] px-1 text-xs leading-none font-medium bg-bg-active text-txt-secondary rounded-full">
