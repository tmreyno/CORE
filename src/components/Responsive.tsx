  ...
  const Handle = () => (
    <div
      class={`
        ...
        ${isVertical() ? "h-1.5 w-full hover:bg-cyan-500/30" : "w-1.5 h-full hover:bg-cyan-500/30"}
        ${isResizing() ? "bg-cyan-500/50" : "bg-zinc-700/50"}
      `}
      style={handleStyle()}
    ...
    >
      <div
        class={`
          rounded-full bg-zinc-500 transition-all
...
export function CollapsibleSidebar(props: CollapsibleSidebarProps) {
  ...
  return (
    ...
    >
      ...
      <button
        class={`
          absolute top-2 z-10 p-1.5 rounded-full bg-zinc-700 hover:bg-zinc-600 
          text-zinc-300 transition-all duration-300 shadow-lg
    ...
    >
      ...
      <div
        class={`
          ...
          ${isDragging() ? "bg-cyan-500/50" : "bg-zinc-700 hover:bg-zinc-600"}
        `}
      ...
      >
        <div
          class={`
            ...
            ${isDragging() ? "bg-cyan-400" : "bg-zinc-500"}
            ${isVertical() ? "w-8 h-1" : "w-1 h-8"}
          `}
        />
      </div>
