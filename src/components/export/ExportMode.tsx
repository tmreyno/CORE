...
import { HiOutlineArrowUpTray, HiOutlineInformationCircle } from "../icons";

export interface ExportModeProps {
  exportName: () => string;
  setExportName: (name: string) => void;
  computeHashes: () => boolean;
  setComputeHashes: (value: boolean) => void;
  verifyAfterCopy: () => boolean;
  setVerifyAfterCopy: (value: boolean) => void;
  generateJsonManifest: () => boolean;
  setGenerateJsonManifest: (value: boolean) => void;
  generateTxtReport: () => boolean;
  setGenerateTxtReport: (value: boolean) => void;
}

export const ExportMode: Component<ExportModeProps> = (props) => {
  return (
