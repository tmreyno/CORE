...
const FIELD_DEFINITIONS: FieldDefinition[] = [
  ...
  { groupId: "users", key: "system.securityHivePresent", label: "Security Hive Present" },
  { groupId: "users", key: "system.securityAccountSidCount", label: "Security Account SID Count" },
  { groupId: "users", key: "system.securityAccountSids", label: "Security Account SIDs" },
  { groupId: "users", key: "system.lsaSecretCount", label: "LSA Secret Count" },
  { groupId: "users", key: "system.lsaSecretsPresent", label: "LSA Secrets Present" },
