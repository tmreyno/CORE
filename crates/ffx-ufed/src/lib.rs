...
//!
//! Standalone crate for parsing UFED (Universal Forensic Extraction Data)
//! containers used in mobile device forensics.
//!
//! ## Supported Formats
//! - **UFD**: Metadata file (INI format with case/device/hash info)
//! - **UFDR**: Standalone extraction file
//! - **UFDX**: Collection index/metadata file (XML format)
//! - **UFED ZIP**: ZIP-packaged extraction set
//!
//! ## Archive Operations
//!
//! UFED ZIP containers require archive operations (extract, list, read).
//! The host application must register an [`archive_ops::ArchiveOps`]
//! implementation at startup via [`archive_ops::register`].
