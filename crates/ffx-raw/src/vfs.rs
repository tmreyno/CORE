...
impl ffx_common::filesystem::BlockDevice for RawBlockDevice {
...
pub struct RawVfs {
    ...
    #[allow(dead_code)]
    partition_table: Option<ffx_common::filesystem::PartitionTable>,
}
...
impl ffx_common::filesystem::BlockDevice for RawBlockDeviceWrapper {
    fn read_at(&self, offset: u64, buf: &mut [u8]) -> Result<usize, ContainerError> {
