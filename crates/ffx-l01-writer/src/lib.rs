...
//!
//! ```rust,no_run
//! use ffx_l01_writer::{L01Writer, L01WriterConfig, L01CaseInfo};
...
pub struct L01Writer {
    pub(crate) config: L01WriterConfig,
    pub(crate) entries: Vec<LefFileEntry>,
    pub(crate) sources: Vec<LefSource>,
    pub(crate) permission_groups: Vec<LefPermissionGroup>,
    pub(crate) subjects: Vec<LefSubject>,
    next_identifier: u64,
}
