...
//!
//! This crate provides centralized definitions for all supported forensic
...
//!
//! ```rust
//! use ffx_formats::{FormatCategory, detect_format_by_extension};
//!
//! let format = detect_format_by_extension("evidence.E01");
//! if let Some(fmt) = format {
//!     println!("Format: {} ({})", fmt.display_name, fmt.category.to_string());
