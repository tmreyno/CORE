...
fn run_full(context: tauri::Context) {
    ...
    let app = match tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::get_project_audit_log_path,
            commands::read_project_audit_log,
            ...
            commands::project_db_hash_source_and_insert,
            commands::project_db_get_hashes_for_file,
            commands::project_db_get_hashes_for_source,
            commands::project_db_summarize_hashes_by_algorithm,
            commands::project_db_get_latest_hash,
            commands::project_db_get_latest_hash_for_source,
            ...
            commands::project_db_summarize_verifications_by_result,
            commands::project_db_upsert_artifact,
            commands::project_db_get_artifact,
            commands::project_db_list_artifacts,
            commands::project_db_list_artifacts_for_evidence,
            commands::project_db_list_artifacts_by_category,
            commands::project_db_summarize_artifacts_by_category,
            ...
            commands::project_db_analyze_source_and_insert,
            ...
            commands::hash_source,
            commands::artifact_extract_source,
            // =====================================================================
            ...
            commands::viewer_detect_type_source,
            commands::viewer_parse_header,
            commands::viewer_parse_header_source,
            ...
            commands::viewer_read_binary_source_base64,
            commands::viewer_read_binary_base64_chunk,
            commands::viewer_read_binary_source_base64_chunk,
            ...
            report::commands::extract_report_evidence_from_project_db,
            ...
            viewer::document::commands::document_read_source,
            viewer::document::commands::document_get_metadata,
            viewer::document::commands::document_get_metadata_source,
            viewer::document::commands::detect_content_format,
            viewer::document::commands::detect_content_format_source,
            viewer::document::commands::spreadsheet_info,
            viewer::document::commands::spreadsheet_info_source,
            viewer::document::commands::spreadsheet_read_sheet,
            viewer::document::commands::spreadsheet_read_sheet_source,
            viewer::document::commands::email_parse_eml,
            viewer::document::commands::email_parse_eml_source,
            viewer::document::commands::email_parse_mbox,
            viewer::document::commands::email_parse_mbox_source,
            viewer::document::commands::email_parse_msg,
            viewer::document::commands::email_parse_msg_source,
            viewer::document::commands::pst_get_folders,
            viewer::document::commands::pst_get_folders_source,
            viewer::document::commands::pst_get_messages,
            viewer::document::commands::pst_get_messages_source,
            viewer::document::commands::pst_get_message_detail,
            viewer::document::commands::pst_get_message_detail_source,
            viewer::document::commands::plist_read,
            viewer::document::commands::plist_read_source,
            viewer::document::commands::exif_extract,
            viewer::document::commands::exif_extract_source,
            viewer::document::commands::binary_analyze,
            viewer::document::commands::binary_analyze_source,
            viewer::document::commands::registry_get_info,
            viewer::document::commands::registry_get_info_source,
            viewer::document::commands::registry_get_subkeys,
            viewer::document::commands::registry_get_subkeys_source,
            viewer::document::commands::registry_get_key_info,
            viewer::document::commands::registry_get_key_info_source,
            viewer::document::commands::database_get_info,
            viewer::document::commands::database_get_info_source,
            viewer::document::commands::database_get_table_schema,
            viewer::document::commands::database_get_table_schema_source,
            viewer::document::commands::database_query_table,
            viewer::document::commands::database_query_table_source,
            viewer::document::commands::office_read_document,
            viewer::document::commands::office_read_document_source,
...
pub fn run_acquire(context: tauri::Context) {
    ...
    let app = match tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::aff4_create_image,
            commands::aff4_cancel_export,
            // Source-aware hashing and artifact extraction
            commands::hash_source,
            commands::artifact_extract_source,
        ])
        .on_window_event(common_window_event)
