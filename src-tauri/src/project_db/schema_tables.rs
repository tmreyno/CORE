...
//! Schema table definitions — CREATE TABLE statements for the project database.
//!
//! Contains the `init_schema()` method that creates all tables, indexes, and FTS5
//! virtual tables for a fresh `.ffxdb` database.
...
impl ProjectDatabase {
    /// Create all tables, indexes, and FTS5 virtual tables for a fresh database.
